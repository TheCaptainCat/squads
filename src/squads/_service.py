...
from squads._itemfile import read_frontmatter, update_frontmatter, write_new
from squads._models import _markers as markers
from squads._models._config import CONFIG_FILENAME, SquadsConfig
from squads._models._enums import FOLDER_BY_TYPE, ItemType, Status
from squads._models._extras import ExtraKey as X
from squads._models._index import SquadsDB
from squads._models._item import Item
from squads._paths import SquadPaths, load_config, number_for_id, resolve
from squads._rendering._engine import render
from squads._roles._catalog import RoleDef, dev_role, resolve_roles, role_by_slug
...
class Service:
    ...
    def refs_in(self, item_id: str) -> list[tuple[str, str]]:
        ...
        out = [
            (it.id, _ref_kinds(it).get(item_id, "related"))
    ...
    def _check_items(
        ...
        for iid, item in index.items.items():
            ...
            issues += [
                CheckIssue("warn", iid, f"dangling ref {ref}")
