...
async def test_a_rename_through_this_writer_is_visible_and_the_create_entry_survives(
    ...
    # this sync is what first regenerates it. That is currency detection doing its job, not a
    # regression: the pointer really was out of date the moment before this call.
    assert skipped == [
