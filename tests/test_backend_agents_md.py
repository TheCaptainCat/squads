...
class TestAgentsMdScaffold:
    async def test_creates_agents_md(self, backend, ctx, squad_root):
    ...
    async def test_does_not_clobber_existing_agents_md(self, backend, ctx, squad_root):
    ...
    async def test_scaffold_idempotent(self, backend, ctx, squad_root):
...
class TestWriteManaged:
    async def test_managed_markers_present(self, backend, ctx, squad_root, roster, operators):
    ...
    async def test_roster_roles_in_managed_section(
    ...
    async def test_operators_in_managed_section(self, backend, ctx, squad_root, roster, operators):
    ...
    async def test_user_prose_preserved(self, backend, ctx, squad_root, roster, operators):
    ...
    async def test_managed_section_not_duplicated(
        self, backend, ctx, squad_root, roster, operators
    ):
...
class TestAgentsMdUsefulnessPin:
    ...
    async def test_workflow_content_in_agents_md_after_sync(self, tmp_path, monkeypatch):
    ...
    async def test_role_mission_in_agents_md_after_sync(self, tmp_path, monkeypatch):
    ...
    async def test_role_definitions_not_title_only_stub(self, tmp_path, monkeypatch):
    ...
    async def test_workflow_alias_table_in_agents_md(
        self, backend, ctx, squad_root, roster, operators
    ):
...
class TestCLIRoundTrip:
    async def test_sq_init_backend_agents_md(self, tmp_path, monkeypatch):
    ...
    async def test_sq_sync_refreshes_agents_md(self, tmp_path, monkeypatch):
    ...
    async def test_sq_init_agents_md_no_claude_dir(self, tmp_path, monkeypatch):
