...
updated_at: '2026-06-14T21:00:52Z'
---
<!-- sq:body -->
## Context

ADR-000071 fixed invariant 1: frontmatter is the source of truth, and `.squads.json` stores
...
FEAT-000027 (explicit ID padding) surfaces a parameter that doesn't fit that frame cleanly. It
...
implementation. The question generalises beyond padding: the global counter (ADR-000072) is the
...
- **Padding follows the counter's exact pattern.** TASK-000101's "repair must preserve the stored
...
- **ADR-000072's "padding is a presentation concern, not part of identity" still holds** — the
...
This **refines** ADR-000071 (it names a permitted second class of index state) and **generalises**
the counter mechanism already accepted in ADR-000072. Both remain accepted and unedited as the
