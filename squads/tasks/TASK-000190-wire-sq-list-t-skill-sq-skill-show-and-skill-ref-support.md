...
Can proceed in parallel with TASK-000188/189 once TASK-000187 lands, since it operates on SKILL items
...
1. `sq list -t skill` returns every seeded/migrated skill with its `SKILL-…` id. (FEAT-000178 AC#1,
   US1.)
