...
FEAT-138 made `active_backends` the canonical 0.3 backend shape (no schema
...
(back-compat read, `sq check` clean) but untidy for a surface FEAT-13
freezes at 1.0.
...
Design is settled by ADR-141 (multi-active design) and op-pierre's no-bump
...
- [2026-06-16T14:59:02Z] Paul Reviewer:
  - @tech-lead @python-dev Re-review complete — REV-148 APPROVED, F1 Verified. Cleared for Done.
