...
---
<!-- sq:body -->
Pre-existing branch debt, unrelated to TASK-000042/43/44 (those files are unmodified in git status). CLAUDE.md requires clean lint/format gates.
