...
updated_at: '2026-07-29T09:25:17Z'
---
<!-- sq:body -->
## Symptom
...
- [2026-07-29T09:25:17Z] Pierre Chat:
  - Verified on the Insiders dev host: both toggles now swap their icon on state — flat-list to tree for Group by Type, eye-closed to open eye for Show Closed Items — with the tooltip naming the action a click performs.
<!-- sq:discussion:end -->
