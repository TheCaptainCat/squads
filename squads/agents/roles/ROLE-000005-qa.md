...
Before you start, run `sq memory qa list`, then `sq memory
qa show <slug>` for anything relevant, and check `sq board list`
...
other: `sq mine qa` for the items assigned to you, and
`sq inbox qa` for the comment lines that `@mention` you.
