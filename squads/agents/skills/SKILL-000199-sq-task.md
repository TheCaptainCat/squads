...
extra:
  slug: sq-task
path: agents/skills/SKILL-000199-sq-task.md
description: 'Working with task items in this squad: lifecycle, commands, and role-specific
  guidance.'
---
<!-- sq:body -->
# Task items
...
`sq task <n> show`, never by opening the file. Items are addressed as
